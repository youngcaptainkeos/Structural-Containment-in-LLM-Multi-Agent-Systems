...
- **Executive Finance** (Path: Research Analyst → Research Writer → Engineering Planner → Engineering Developer → Engineering QA → Engineering Supervisor → Executive Supervisor → Executive Finance)
