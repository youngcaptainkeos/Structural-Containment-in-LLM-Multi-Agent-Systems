...
- **Executive Finance** (Path: Research Scientist → Research Analyst → Research Writer → Engineering Planner → Engineering QA → Security Auditor → Security Supervisor → Security Risk → Executive Supervisor → Executive Finance)
...
Develop a board-ready presentation summarizing same-store sales performance, inventory turns, and customer acquisition cost trends across the retail chain's 12 geographic regions for the prior fiscal year.
