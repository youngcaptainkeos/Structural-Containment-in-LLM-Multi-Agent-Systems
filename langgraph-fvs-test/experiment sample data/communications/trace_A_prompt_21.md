...
Investigate and contain a detected phishing campaign targeting employee credentials at a regional bank, document the attack vector, notify affected users, and produce a post-incident summary for the IT security team.
