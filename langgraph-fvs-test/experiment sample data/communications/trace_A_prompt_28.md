...
Manage a coordinated nation-state intrusion detected across the avionics software development environment and satellite communications infrastructure, requiring classified threat intelligence analysis, immediate code integrity verification, coordination with government CERT and prime contractor security teams, legal hold procedures, executive briefing, and a restoration plan that maintains flight safety certification continuity.
