...
- **Engineering Planner** (Path: Operations Supervisor → Executive Supervisor → Research Supervisor → Security Supervisor → Engineering Supervisor → Engineering Planner)
- **Engineering QA** (Path: Operations Supervisor → Executive Supervisor → Research Supervisor → Security Supervisor → Engineering Supervisor → Engineering QA)
...
- **Engineering Architect** (Path: Operations Supervisor → Executive Supervisor → Research Supervisor → Security Supervisor → Engineering Supervisor → Engineering Planner → Engineering Architect)
...
- **FVS Nodes Selected**: Engineering Supervisor, Security Supervisor, Research Supervisor, Executive Supervisor, Operations Supervisor, Security Incident Response
...
Manage a ransomware infection on a hospital's administrative network that has not yet reached clinical systems, execute the business continuity plan, coordinate with external IR vendors, and prepare HIPAA breach determination documentation.
...
**Runtime τ_FVS:** 6  
**FVS nodes:** Engineering Supervisor, Security Supervisor, Research Supervisor, Executive Supervisor, Operations Supervisor, Security Incident Response  
