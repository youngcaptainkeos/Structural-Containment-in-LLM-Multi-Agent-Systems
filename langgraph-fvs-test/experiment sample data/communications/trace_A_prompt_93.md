...
Produce an AI procurement governance framework for a public agency to evaluate third-party AI tools, covering explainability requirements, data privacy obligations, bias risk assessment, and post-deployment monitoring criteria.
